...
def closest_object_roberta(key, corpus, gpu_num):
...
def gptResponseToAlfredPlan(sentence, gpu_num=0):
    plan = sentence.split('\n')
    action_seq = []; cos_score = []
    available_actions = json.load(open('data/available_actions1.json', 'r'))
